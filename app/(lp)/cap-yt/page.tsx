    ...
    <div className="flex flex-col">
      ...
      <Navbar
        ...
        button={
          <Button
            ...
            hrefLink="https://forms.gle/R7WokJPHq9KB9jzr6"
            external
          />
        }
      />
      ...
      <Container>
        <Hero
          ...
          buttonHref="https://forms.gle/R7WokJPHq9KB9jzr6"
          buttonText="apply now"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-5">
          <div className="col-span-1 order-last md:order-first">
            <SideBox
              ...
              ctaButtonHref="https://forms.gle/R7WokJPHq9KB9jzr6"
      ...
      <Container>
        <FeatureCard
          ...
          buttonText="apply now"
          href="https://forms.gle/R7WokJPHq9KB9jzr6"
          external
        />
      </Container>
